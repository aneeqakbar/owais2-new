...
urlpatterns = [
    ...
    path('google-sheet-data/', views.ScraperDashboardView.as_view(), name="ScraperDashboardView"),
    path('google-sheet-data/<str:slug>/', views.ScraperDataView.as_view(), name="ScraperDataView"),
    path('chart-data/<int:data_id>/<str:field>/', views.ViewDataChartAnalytics.as_view(), name="ViewDataChartAnalytics"),
]